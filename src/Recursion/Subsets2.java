...
public class Subsets2 {
    ...
    public static void main(String[] args) {
         ...
         * REMOVE THE ELEMENT WE HAD CHOSEN, THE MAIN DIFFERENCE IS THAT IN BRUTE APPROACH, WE STRICTLY FOLLOW
         * PICK AND NOT PICK, WHERE AS IN 2ND WE AIM TO SKIP THE DUPLICATE ONES.
         *
         * WE CAN ALSO SAY THAT BRUTE FOLLOWS PICK AND NOT PICK, WHERE AS OPTIMAL FOLLOWS SUBSEQUENCE APPROACH
         *
         ...
         *
         * WHY WE CALL THIS OPTIMAL APPROACH A SUBSEQUENCE ONE, BECAUSE LETS SAY FOR ARRAY 1 2 2 3, 1 2 3 WILL BE A SUBSET
         * AS IT DOESN'T ALLOW DUPLICATES, SO IN A WAY WE WOULD BE FORMING SUBSEQUENCE WITH 1 2 AND 3.
         */
        int arr[] = {1,2,2};
        subsetsWithDup(arr);
    }
