...
public class CountReversePairs {
    ...
    public static void main(String[] args) {
        /**
         * THE QUESTION STATES THAT WE ARE GIVEN AND ARRAY AND WE NEED TO FIND THOSE PAIRS WHERE LEFT ELEMENT IS MORE THAN
         * TWICE THE RIGHT ELEMENT, EG FOR 4 3 2 1, PAIRS ARE 4 1, 3 1 MEANS 2 PAIR
         *
        ...
        /**
         * NOTE :
         * WHY IN THIS QUESTION WE DON'T CHECK THE SAME WAY LIKE WE DID IN INVERSIONS IN ARRAY
         * BECAUSE IN THAT WE JUST NEEDED TO CHECK WHETHER IF AN ARRAY ELEMENT IS BIGGER THAN AND THAT IS WHY IT WORKED FINE
         * BUT IN THIS HAD WE APPLIED THE SAME LOGIC THEN A CASE MIGHT HAVE ARISED
         * LIKE
         * 25 50 IS LEFT AND 12 24 IS RIGHT, HAD IT BEEN INVERSIONS THEN WE COULD HAVE EASILY CHECKED
         * AS 25 WOULD BE BIGGER THAN 12, 2 INVERSIONS AND 25 IS BIGGER THAN 24 2 INVERSIONS
         *
         * IF WE HAVE APPLIED SIMILAR LOGIC, ONLY CHECKING IF ARR[I] > 2 * ARR[J]
         * THEN 25 WOULD HAVE GREATER THAN 24, THEN 2 CASE(25 AND 50 WITH 12)
         *
         * NOW 25 WOULD HAVE CHECKED WITH 24 * 2 = 48 AND THE RESULT WOULD NOT HAVE PASSED THE IF CASE AND J WOULD BE OUT OF
         * BOUNDS, MEANING WE MISSED OUR 50 > 24 * 2.
         *
         * SO THAT IS WHY WE COMPARE THE RIGHT SIDE WITH THE LEFT ELEMENTS, AND WE KEEP ON INCREMENTING J TILL ARR[I] >
         * ARR[J] * 2.
         *
         */
        int arr[] = {1,3,2,3,1};
