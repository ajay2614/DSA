...
public class CountSubArraysWithXor {
    ...
    public static void main(String[] args) {
         ...
         *
         *  THE FIRST SUBARRAY CONSISTING OF 4 AND COMPLETE SUBARRAY GIVES XOR 2, 4 ^ 2 = 6 MEANING WE ARE BOUND TO GET
         ...
         *  XOR OF COMPLETE XOR WITH TARGET 6 GIVES US XOR 4, AS 4 HAS ALREADY BEEN THERE WE KNOW IT IS ONLY THERE BECAUSE THERE
